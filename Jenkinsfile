pipeline {
    ...
    parameters {
     ...
     environment {
        ...
        SSH_KEY = "/home/ubuntu/.ssh/terraform1.pem"  // Replace with your private key
        ANSIBLE_PLAYBOOK = "tomcatinstall.yml"
        GIT_REPO = "https://github.com/sonyhl05/Ansible_playbook_sonyhl.git"
    }
    ...
    stages {
                    ...
                    script {
                        dir("terraform") {
                            ...
                            sh '''
                                ...
                                git clone "https://github.com/sonyhl05/terraform-new.git"
                            '''
                        }
                    }
                }
        ...
        stage('Plan') {
          ...
          steps {
                dir('terraform/terraform-new') {  // Adjust path as needed
        ...
        stage('Apply') {
           ...
           steps {
                dir('terraform/terraform-new') {  // Add this directory block, same as in Plan stage
